...
features:add(nn.Transpose({4,1},{4,2},{4,3}))   
   ...
   features:add(inn.SpatialStochasticPooling(3,3,2,2))                   -- 55 ->  27
features:add(nn.Transpose({1,4},{1,3},{1,2}))   
...
features:add(nn.Transpose({4,1},{4,2},{4,3}))   
   ...
   features:add(inn.SpatialStochasticPooling(3,3,2,2))                   --  27 ->  13
features:add(nn.Transpose({1,4},{1,3},{1,2}))   
...
features:add(nn.Transpose({4,1},{4,2},{4,3}))
   ...
   features:add(inn.SpatialStochasticPooling(3,3,2,2))                   -- 13 -> 6)
   --features:add(nn.Transpose({4,1},{4,2},{4,3}))
